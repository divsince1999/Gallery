...
import { User, LayoutDashboard, Palette, LogOut } from "lucide-react";
    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-white shadow-md">
        ...
        <div className="absolute bottom-0 w-64 border-t p-4">
          ...
          <Link href="/api/auth/signout" className="flex items-center text-red-600 hover:text-red-700 px-2">
